        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-white/80">
              Bergabunglah dalam gerakan pengelolaan sampah yang berkelanjutan.
              Pelajari cara mengolah sampah dan dapatkan reward dari kontribusi
              Anda.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                User terverifikasi dapat mengajukan hasil olahan sampah ke bank
                sampah terdekat.
              </p>
            </div>
      ...
      {!session && (
        <section className="py-16 bg-primary text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 text-white/90">
              Daftar sekarang dan jadilah bagian dari solusi pengelolaan sampah
              yang berkelanjutan
            </p>
            <Link
              href="/auth/register"
