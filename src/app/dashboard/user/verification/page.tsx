    ...
    <div className="max-w-3xl">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-red-700 text-sm">
                Permohonan verifikasi Anda ditolak. Silakan perbaiki dokumen dan
                ajukan kembali.
              </p>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        ...
        <p className="text-blue-800 text-sm mb-3">
          Untuk menjadi pengguna terverifikasi dan dapat menjual olahan sampah,
          Anda perlu melampirkan:
        </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Upload dokumen ke layanan cloud (Google Drive, Dropbox, dll) dan
                salin linknya di sini
              </p>
            </div>
